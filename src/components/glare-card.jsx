...
export const GlareCard = ({
  ...
  return (
    (<div
      ...
      className="relative scale-90 transition hover:scale-95 isolate [contain:layout_style] [perspective:600px] duration-300 ease-in-out delay-[var(--delay)] will-change-transform w-[300px] [aspect-ratio:17/25]"
      ref={refElement}
      onPointerMove={(event) => {
      ...
      <div
        className="h-full grid will-change-transform origin-center transition-transform  delay-[var(--delay)] [transform:rotateY(var(--r-x))_rotateX(var(--r-y))] rounded-[var(--radius)] border border-slate-800 hover:[--opacity:0.6] hover:[--duration:200ms] hover:[--easing:linear] hover:filter-none overflow-hidden shadow-sm shadow-white  hover:shadow-lg transistion duration-300 ease-in-out hover:shadow-white">
        <div
